...
private:
    ...
    void WRITE()
    {
        ...
        outfile.open("output_phase2.txt", ios::app);
        bool flag=true;
    ...
    void TERMINATE(int EM)
    {
        ...
        PI = 0;
        TI = 0;
        outfile << "_________________________________________________________________\n\n";
    ...
    for (int i = 0; i < 300; i++) {
        cout << "[ " << i << " ] : ";
        for (int j = 0; j < 4; j++) {
            cout << (Memory[i][j] == '\0' ? '-' : Memory[i][j]) << " ";
        }
        cout << '\n';
    }
    cout << "--- End of Memory Table ---\n";
}
...
int main()
{
    printf("Multiprogramming Operating System \nPresented By Group 9 \n\n Prasanna Khebade \n Rohit Jadhav\n Ritik Singh\n Shyamsundar More\n\n\n");
    VM vm;
    return 0;
